...
class View:
    ...
    def load_interface(self):
        ...
        # Riga 1
        self.dd_category = ft.Dropdown(label="Categoria", width=200, on_change=self.controller.get_selected_cat) # TODO: Gestire il dropdown
        ...
        self.dd_prodotto_iniziale = ft.Dropdown(label="Prodotto Iniziale", width=350, on_change=self.controller.get_selected_prod_in) # TODO: Gestire il dropdown
        self.dd_prodotto_finale = ft.Dropdown(label="Prodotto Finale", width=350, on_change=self.controller.get_selected_prod_fin) # TODO: Gestire il dropdown
